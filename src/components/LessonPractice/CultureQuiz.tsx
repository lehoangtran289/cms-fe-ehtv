                ...
                <SwiperSlide key={index}>
                  <section className="pt-4 pb-20">
                    <ParallelDocument
                      ...
                      bottomRegion={
                        <button
                          className="text-center block m-auto bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 mt-5 border border-blue-500 hover:border-transparent rounded"
                          onClick={() =>
                            swal(`${item.answer}`, 'Đúng rồi!', 'success')
                          }>
                          Đáp án
                        </button>
                      }
